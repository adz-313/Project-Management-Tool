 ...
 */
@MultipartConfig
public class AddGuidelineServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddGuidelineServlet</title>");
            out.println("</head>");
            out.println("<body>");
